...
> 💡 **Core Highlight**：本儲存庫主要展示系統的**核心後端架構（Backend Architecture）**與 **AI/RAG 研發成果**。全案本人開發 70% 的 Python 程式碼，實作了非同步任務佇列、即時雙向通訊、多服務容器化部署及精準的 RAG 混合檢索 Pipeline，展現具備解決複雜併發與資料流阻塞的後端工程能力。
